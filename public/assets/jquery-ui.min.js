...
(function (b, d) {
    ...
    if (!b.ui.version) {
        ...
        b.fn.extend({
            _focus: b.fn.focus, focus: function (f, g) {
...
(function (b) {
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _refreshItems: function (d) {
            ...
            var e = this.items, f = [[b.isFunction(this.options.items) ? this.options.items.call(this.element[0], d, {item: this.currentItem}) : b(this.options.items, this.element),
...
jQuery.effects || function (b, d) {
    ...
    b.fn.extend({
        _addClass: b.fn.addClass, addClass: function (l, k, m, p) {
            return k ? b.effects.animateClass.apply(this, [{add: l}, k, m, p]) : this._addClass(l)
        }, _removeClass: b.fn.removeClass, removeClass: function (l, k, m, p) {
            return k ? b.effects.animateClass.apply(this, [{remove: l}, k, m, p]) : this._removeClass(l)
            ...
            return b.effects.animateClass.apply(this, [{add: k, remove: l}, m, p, q])
        }
    });
    b.extend(b.effects, {
        version: "1.8.12", save: function (l, k) {
    ...
    b.extend(b.easing, {
        def: "easeOutQuad", swing: function (l, k, m, p, q) {
    ...
    b.effects.puff = function (d) {
        return this.queue(function () {
            ...
            b.extend(d.options, {
                ...
                from: f == "hide" ? c : {height: c.height * a, width: c.width * a}
            });
        ...
        options: {
            ...
            if (b.isArray(this.options.source)) {
                ...
                this.source = function (a, c) {
                    e.xhr && e.xhr.abort();
                    e.xhr = b.ajax({
                        url: g, data: a, dataType: "json", autocompleteRequest: ++d, success: function (h) {
...
(function (b, d) {
    var e = {
        ...
        minWidth: true,
        width: true
    }, f = {maxHeight: true, maxWidth: true, minHeight: true, minWidth: true}, g = b.attrFn || {
            val: true,
            css: true,
            html: true,
            text: true,
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (o) {
                ...
                if (f.options.range === true)if (f.orientation === "horizontal") {
                    ...
                    if (o === 1)f.range[g ? "animate" : "css"]({width: a - h + "%"}, {
                        queue: false,
                        duration: e.animate
                    })
                } else {
                    if (o === 0)f.range.stop(1, 1)[g ? "animate" : "css"]({bottom: a + "%"}, e.animate);
                    if (o === 1)f.range[g ? "animate" : "css"]({height: a - h + "%"}, {
                        queue: false,
                        duration: e.animate
                    })
                }
                ...
                if (d === "max" && this.orientation === "horizontal")this.range[g ? "animate" : "css"]({width: 100 - a + "%"}, {
                    queue: false,
                    duration: e.animate
                });
                if (d === "min" && this.orientation === "vertical")this.range.stop(1, 1)[g ? "animate" : "css"]({height: a + "%"}, e.animate);
                if (d === "max" && this.orientation === "vertical")this.range[g ? "animate" : "css"]({height: 100 - a + "%"}, {
                    queue: false,
                    duration: e.animate
                })
            }
