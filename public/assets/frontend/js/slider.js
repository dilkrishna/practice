            ...
            if (g == 0) {
                ...
                if (h.hasClass("tp-videolayer") || h.find("iframe").length > 0 || h.find("video").length > 0) {
                    ...
                    if (S != t && String(S).length > 1 && h.find("iframe").length == 0) {
                        ...
                        h.append('<iframe style="visible:hidden" src="' + A + ":http://www.youtube.com/embed/" + S + "?" + E + '" width="' + b + '" height="' + w + '" style="width:' + b + "px;height:" + w + 'px"></iframe>')
                    }
                    if (x != t && String(x).length > 1 && h.find("iframe").length == 0) {
                        if (location.protocol === "https:")A = "https";
                        h.append('<iframe style="visible:hidden" src="' + A + ":http://player.vimeo.com/video/" + x + "?" + E + '" width="' + b + '" height="' + w + '" style="width:' + b + "px;height:" + w + 'px"></iframe>')
                    }
