+function ($) {
    ...
    !function (e) {
        var t = function (e) {
            ...
            e.find(".flip-front").css({transform: t + (e.data("reverse") ? "(-180deg)" : "(180deg)")}), e.find(".flip-back").css({transform: t + "(0deg)"})
        }, i = function (e) {
            e.data("fliped", !1);
            var t = "rotate" + e.data("axis");
            e.find(".flip-front").css({transform: t + "(0deg)"}), e.find(".flip-back").css({transform: t + (e.data("reverse") ? "(180deg)" : "(-180deg)")})
        };
        e.fn.flip = function (a) {
            return this.each(function () {
                var r = e(this);
                if (void 0 !== a && "boolean" == typeof a)a ? t(r) : i(r); else {
                    var s = e.extend({axis: "y", reverse: !1, trigger: "click", speed: 500}, a);
                    if (r.data("reverse", s.reverse), r.data("axis", s.axis), "x" == s.axis.toLowerCase())var o = 2 * r.outerHeight(), n = "rotatex"; else var o = 2 * r.outerWidth(), n = "rotatey";
                    r.find(".flip-back").css({transform: n + "(" + (s.reverse ? "180deg" : "-180deg") + ")"}), r.css({
                        perspective: o,
                        position: "relative"
                    });
                    var f = s.speed / 1e3 || .5;
                    if (r.find(".flip-front, .flip-back").outerHeight(r.height()).outerWidth(r.width()).css({
                        ...
                        var d = function () {
                            r.unbind("mouseleave", c), t(r), setTimeout(function () {
                                r.bind("mouseleave", c), r.is(":hover") || i(r)
                            }, s.speed + 150)
                        }, c = function () {
                            i(r)
                        };
    ...
    !function (t) {
        function e() {
            function e(t) {
                ...
                a - o >= 1e3 && (u._updateTargets(), o = a), n(e)
            }
            ...
            }, s = window.performance && "function" == typeof window.performance.now, n = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || null, o = 0;
        ...
        function i(e, i) {
            return "option" == e && (0 == i.length || 1 == i.length && "string" == typeof i[0]) ? !0 : t.inArray(e, p) > -1
        }

        var s = 0, n = 1, o = 2, a = 3, r = 4, l = 5, _ = 6;
        t.extend(e.prototype, {
            ...
            _attachPlugin: function (e, i) {
                if (e = t(e), !e.hasClass(this.markerClassName)) {
                    var s = {options: t.extend({}, this._defaults), _periods: [0, 0, 0, 0, 0, 0, 0]};
                    ...
                    for (var e = new Date, i = e.getFullYear(), s = e.getMonth(), n = e.getDate(), o = e.getHours(), a = e.getMinutes(), r = e.getSeconds(), l = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, _ = l.exec(t); _;) {
                        switch (_[2] || "s") {
                            ...
                            case"w":
                                ...
                                break;
                            case"o":
                                s += parseInt(_[1], 10), n = Math.min(n, u._getDaysInMonth(i, s));
                                break;
                            case"y":
                                i += parseInt(_[1], 10), n = Math.min(n, u._getDaysInMonth(i, s))
                        }
                        _ = l.exec(t)
                    }
            ...
            _generateHTML: function (e) {
                ...
                for (var p = !1, c = 0, h = e.options.significant, d = t.extend({}, e._show), m = s; _ >= m; m++)p |= "?" == e._show[m] && e._periods[m] > 0, d[m] = "?" != e._show[m] || p ? e._show[m] : null, c += d[m] ? 1 : 0, h -= e._periods[m] > 0 ? 1 : 0;
                for (var g = [!1, !1, !1, !1, !1, !1, !1], m = _; m >= s; m--)e._show[m] && (e._periods[m] ? g[m] = !0 : (g[m] = h > 0, h--));
                var f = e.options.compact ? e.options.compactLabels : e.options.labels, w = e.options.whichLabels || this._normalLabels, y = function (t) {
                    var s = e.options["compactLabels" + w(e._periods[t])];
                    return d[t] ? i._translateDigits(e, e._periods[t]) + (s ? s[t] : f[t]) + " " : ""
                }, D = function (t) {
                    var s = e.options["labels" + w(e._periods[t])];
                    return !e.options.significant && d[t] || e.options.significant && g[t] ? '<span class="' + u._sectionClass + '"><span class="' + u._amountClass + '">' + i._translateDigits(e, e._periods[t]) + "</span><br/>" + (s ? s[t] : f[t]) + "</span>" : ""
                };
                return e.options.layout ? this._buildLayout(e, d, e.options.layout, e.options.compact, e.options.significant, g) : (e.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (e._hold ? " " + this._holdingClass : "") + '">' + y(s) + y(n) + y(o) + y(a) + (d[r] ? this._minDigits(e, e._periods[r], 2) : "") + (d[l] ? (d[r] ? e.options.timeSeparator : "") + this._minDigits(e, e._periods[l], 2) : "") + (d[_] ? (d[r] || d[l] ? e.options.timeSeparator : "") + this._minDigits(e, e._periods[_], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (e.options.significant || c) + (e._hold ? " " + this._holdingClass : "") + '">' + D(s) + D(n) + D(o) + D(a) + D(r) + D(l) + D(_)) + "</span>" + (e.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + e.options.description + "</span>" : "")
            },
            _buildLayout: function (e, i, p, u, c, h) {
                for (var d = e.options[u ? "compactLabels" : "labels"], m = e.options.whichLabels || this._normalLabels, g = function (t) {
                    ...
                    y1: f(e._periods[s], 1),
                    y10: f(e._periods[s], 10),
                    y100: f(e._periods[s], 100),
                    y1000: f(e._periods[s], 1e3),
                    ol: g(n),
                    ...
                    w1: f(e._periods[o], 1),
                    w10: f(e._periods[o], 10),
                    w100: f(e._periods[o], 100),
                    w1000: f(e._periods[o], 1e3),
                    dl: g(a),
                    ...
                    h1: f(e._periods[r], 1),
                    h10: f(e._periods[r], 10),
                    h100: f(e._periods[r], 100),
                    h1000: f(e._periods[r], 1e3),
                    ml: g(l),
                    mn: this._minDigits(e, e._periods[l], 1),
                    mnn: this._minDigits(e, e._periods[l], 2),
                    mnnn: this._minDigits(e, e._periods[l], 3),
                    m1: f(e._periods[l], 1),
                    m10: f(e._periods[l], 10),
                    m100: f(e._periods[l], 100),
                    m1000: f(e._periods[l], 1e3),
                    sl: g(_),
                    sn: this._minDigits(e, e._periods[_], 1),
                    snn: this._minDigits(e, e._periods[_], 2),
                    snnn: this._minDigits(e, e._periods[_], 3),
                    s1: f(e._periods[_], 1),
                    s10: f(e._periods[_], 10),
                    s100: f(e._periods[_], 100),
                    s1000: f(e._periods[_], 1e3)
                }, y = p, D = s; _ >= D; D++) {
                    var T = "yowdhms".charAt(D), v = new RegExp("\\{" + T + "<\\}([\\s\\S]*)\\{" + T + ">\\}", "g");
                    y = y.replace(v, !c && i[D] || c && h[D] ? "$1" : "")
                }
            ...
            _determineShow: function (t) {
                ...
                return i[s] = e.match("y") ? "?" : e.match("Y") ? "!" : null, i[n] = e.match("o") ? "?" : e.match("O") ? "!" : null, i[o] = e.match("w") ? "?" : e.match("W") ? "!" : null, i[a] = e.match("d") ? "?" : e.match("D") ? "!" : null, i[r] = e.match("h") ? "?" : e.match("H") ? "!" : null, i[l] = e.match("m") ? "?" : e.match("M") ? "!" : null, i[_] = e.match("s") ? "?" : e.match("S") ? "!" : null, i
            },
            _calculatePeriods: function (t, e, i, p) {
                t._now = p, t._now.setMilliseconds(0);
                var c = new Date(t._now.getTime());
                t._since ? p.getTime() < t._since.getTime() ? t._now = p = c : p = t._since : (c.setTime(t._until.getTime()), p.getTime() > t._until.getTime() && (t._now = p = c));
                var h = [0, 0, 0, 0, 0, 0, 0];
                if (e[s] || e[n]) {
                    var d = u._getDaysInMonth(p.getFullYear(), p.getMonth()), m = u._getDaysInMonth(c.getFullYear(), c.getMonth()), g = c.getDate() == p.getDate() || c.getDate() >= Math.min(d, m) && p.getDate() >= Math.min(d, m), f = function (t) {
                        return 60 * (60 * t.getHours() + t.getMinutes()) + t.getSeconds()
                    }, w = Math.max(0, 12 * (c.getFullYear() - p.getFullYear()) + c.getMonth() - p.getMonth() + (c.getDate() < p.getDate() && !g || g && f(c) < f(p) ? -1 : 0));
                    h[s] = e[s] ? Math.floor(w / 12) : 0, h[n] = e[n] ? w - 12 * h[s] : 0, p = new Date(p.getTime());
                    var y = p.getDate() == d, D = u._getDaysInMonth(p.getFullYear() + h[s], p.getMonth() + h[n]);
                    p.getDate() > D && p.setDate(D), p.setFullYear(p.getFullYear() + h[s]), p.setMonth(p.getMonth() + h[n]), y && p.setDate(D)
                }
                var T = Math.floor((c.getTime() - p.getTime()) / 1e3), v = function (t, i) {
                    h[t] = e[t] ? Math.floor(T / i) : 0, T -= h[t] * i
                };
                if (v(o, 604800), v(a, 86400), v(r, 3600), v(l, 60), v(_, 1), T > 0 && !t._since)for (var C = [1, 12, 4.3482, 7, 24, 60, 60], M = _, b = 1, S = _; S >= s; S--)e[S] && (h[M] >= b && (h[M] = 0, T = 1), T > 0 && (h[S]++, T = 0, M = S, b = 1)), b *= C[S];
                if (i)for (var S = s; _ >= S; S++)i && h[S] ? i-- : i || (h[S] = 0);
                return h
            }
        });
        var p = ["getTimes"];
        t.fn.countdown = function (t) {
            ...
            return i(t, e) ? u["_" + t + "Plugin"].apply(u, [this[0]].concat(e)) : this.each(function () {
                if ("string" == typeof t) {
                    if (!u["_" + t + "Plugin"])throw"Unknown command: " + t;
                    u["_" + t + "Plugin"].apply(u, [this].concat(e))
                } else u._attachPlugin(this, t || {})
            })
        };
        var u = t.countdown = new e
    }(jQuery);
