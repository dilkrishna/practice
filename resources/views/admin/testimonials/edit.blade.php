    ...
    <div class="block">
        ...
        <form action="" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-xs-2 control-label" for="first_title">First Name</label>
            ...
            <input type="hidden" name="country_val" id="country_val"
                   value="{{(!empty($query) ? $query['country'] : '')}}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                <textarea id="content" name="description" class="ckeditor form-control"
