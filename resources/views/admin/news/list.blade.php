                        ...
                        <tr id="{{$row['id']}}">
                            ...
                            <td class="text-center">
                                <a href="#modal-fade" data-toggle="modal" title="view"
                                   ...
                                   data-date_published="{{ $row['date_published'] }}"><i class="fa fa-eye"></i></a>

                                <a href="{{URL::to('/admin/news/edit/'.$row['id'])}}" data-toggle="tooltip"
                                   title="edit" class="btn btn-effect-ripple btn-xs btn-success"><i
                                            class="fa fa-pencil"></i></a>
                                <a href="#" data-href="{{URL::to('/admin/news/delete/'.$row['id'])}}"
    ...
    <script type="text/javascript">
        $(function () {
            $('a.view-modal').click(function (e) {
                ...
                var seo_title = $(this).attr('data-seo_title');
                var seo_description = $(this).attr('data-seo_description');
                var date_published = $(this).attr('data-date_published');
                $('td#title').html(title);
                $('td#description').html(description);
                $('td#seo_title').html(seo_title);
                $('td#seo_description').html(seo_description);
                $('td#date_published').html(date_published);
            })
        });
        ...
        $(function () {
            ...
            $("#example-datatable tbody").sortable({
                ...
                stop: function (e, ui) {
                    ...
                    $.ajax({
                        url: '{{URL::to('/admin/updateOrder/news')}}',
                        type: 'POST',
